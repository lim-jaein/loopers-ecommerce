...
//            ProductLikeCount productLikeCount = ProductLikeCount.create(product.getId());
//
//            // act
//            likeDomainService.applyLike(productLikeCount, like);
//
//            // assert
...
//            ProductLikeCount productLikeCount = ProductLikeCount.create(product.getId());
//            like.like();
//            productLikeCount.increaseLikeCount();
//
//            // act
//            likeDomainService.applyLike(productLikeCount, like);
//
...
////
////            // act
////            likeDomainService.applyUnLike(product, like);
////
////            // assert
